...
RUN . $SPACK_ROOT/share/spack/setup-env.sh && spack spec octopus +netcdf+metis+arpack+cgal+pfft+python+likwid+libyaml+nlopt+sparskit # serial version
...
RUN . $SPACK_ROOT/share/spack/setup-env.sh && spack install octopus +netcdf+metis+arpack+cgal+pfft+python+likwid+libyaml+nlopt+sparskit # serial version
